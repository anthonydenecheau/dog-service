...
public class Owner implements Serializable {
   ...
   public Owner withZipCode(String zipCode) {
      this.setZipCode(zipCode);
      return this;
   }

   public Owner withTown(String town) {
      this.setTown(town);
      return this;
   }

   public Owner withCountry(String country) {
      this.setCountry(country);
      return this;
   }

   public Owner withIdDog(int idDog) {
      this.setIdDog(idDog);
      return this;
   }

   public Owner withTimestamp(Timestamp timestamp) {
   ...
   public String toString() {
      return "Owner [id=" + id + ", lastName=" + lastName + ", firstName=" + firstName + ", address=" + address
            + ", zipCode=" + zipCode + ", town=" + town + ", country=" + country + ", idDog=" + idDog + ", timestamp="
            + timestamp + "]";
   }
