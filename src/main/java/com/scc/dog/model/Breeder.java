...
public class Breeder {
   ...
   public Breeder withProfessionnelActif(String professionnelActif) {
   ...
   public Breeder withTimestamp(Timestamp timestamp) {
   ...
   public String toString() {
      return "Breeder [id=" + id + ", civility=" + civility + ", lastName=" + lastName + ", firstName=" + firstName
            + ", typeProfil=" + typeProfil + ", professionnelActif=" + professionnelActif + ", raisonSociale="
            + raisonSociale + ", pays=" + pays + ", onSuffixe=" + onSuffixe + ", idDog=" + idDog + ", timestamp="
            + timestamp + "]";
   }
