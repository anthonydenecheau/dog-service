...
public class DogObject {
	...
	public DogObject withSexe(String sexe){ this.setSexe(sexe); return this; }
	public DogObject withDateNaissance(String dateNaissance){ this.setDateNaissance(dateNaissance); return this; }
	public DogObject withLof(String lof){ this.setLof(lof); return this; }
	public DogObject withTatouage(String tatouage){ this.setTatouage(tatouage); return this; }
	public DogObject withTranspondeur(String transpondeur){ this.setTranspondeur(transpondeur); return this; }
	public DogObject withRace(String race){ this.setRace(race); return this; }
	public DogObject withVariete(String variete){ this.setVariete(variete); return this; }
	public DogObject withCouleur(String couleur){ this.setCouleur(couleur); return this; }
