...
public class BreederObject {
   ...
   public BreederObject withCivility(String civility) {
      this.setCivility(civility);
      return this;
   }

   public BreederObject withFirstName(String firstName) {
      this.setFirstName(firstName);
      return this;
   }

   public BreederObject withLastName(String lastName) {
      this.setLastName(lastName);
      return this;
   }

   public BreederObject withCountry(String country) {
      this.setCountry(country);
      return this;
   }

   public BreederObject withOnSuffixe(String onSuffixe) {
