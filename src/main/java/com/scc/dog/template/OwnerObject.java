...
public class OwnerObject {
   ...
   public OwnerObject withFirstName(String firstName) {
      this.setFirstName(firstName);
      return this;
   }

   public OwnerObject withLastName(String lastName) {
      this.setLastName(lastName);
      return this;
   }

   public OwnerObject withAddress(String address) {
      this.setAddress(address);
      return this;
   }

   public OwnerObject withZipCode(String zipCode) {
      this.setZipCode(zipCode);
      return this;
   }

   public OwnerObject withTown(String town) {
      this.setTown(town);
      return this;
   }

   public OwnerObject withCountry(String country) {
