...
public class DogObject {
   ...
   public List<PedigreeObject> getPedigrees() {
      return pedigrees;
   }

   public void setPedigrees(List<PedigreeObject> pedigrees) {
   ...
   public BreedObject getBreed() {
      return breed;
   }

   public void setBreed(BreedObject breed) {
      this.breed = breed;
   }

   public Map<String, Object> getFather() {
      return father;
   }

   public void setFather(Map<String, Object> father) {
      this.father = father;
   }

   public Map<String, Object> getMother() {
      return mother;
   }

   public void setMother(Map<String, Object> mother) {
      this.mother = mother;
   }

   public BreederObject getBreeder() {
      return breeder;
   }

   public void setBreeder(BreederObject breeder) {
      this.breeder = breeder;
   }

   public List<OwnerObject> getOwners() {
      return owners;
   }

   public void setOwners(List<OwnerObject> owners) {
      this.owners = owners;
   }

   public List<TitleObject> getTitles() {
      return titles;
   }

   public void setTitles(List<TitleObject> titles) {
      this.titles = titles;
   }
   ...
   public DogObject withName(String name) {
      this.setName(name);
      return this;
   }

   public DogObject withGender(String gender) {
      this.setGender(gender);
      return this;
   }

   public DogObject withBirthDate(String birthDate) {
      this.setBirthDate(birthDate);
      return this;
   }

   public DogObject withBirthCountry(String birthCountry) {
      this.setBirthCountry(birthCountry);
      return this;
   }

   public DogObject withTokens(List<Map<String, Object>> tokens) {
      this.setTokens(tokens);
      return this;
   }

   public DogObject withPedigrees(List<PedigreeObject> pedigrees) {
      this.setPedigrees(pedigrees);
      return this;
   }

   public DogObject withBreed(BreedObject breed) {
      this.setBreed(breed);
      return this;
   }

   public DogObject withFather(Map<String, Object> father) {
      this.setFather(father);
      return this;
   }

   public DogObject withMother(Map<String, Object> mother) {
      this.setMother(mother);
      return this;
   }

   public DogObject withBreeder(BreederObject breeder) {
      this.setBreeder(breeder);
      return this;
   }

   public DogObject withOwners(List<OwnerObject> owner) {
      this.setOwners(owner);
      return this;
   }

   public DogObject withTitles(List<TitleObject> titles) {
   ...
   public DogObject withAffixe(String affixe) {
